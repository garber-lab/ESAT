...
import umms.core.readFilters.ReadEndsInFilter;

public class EndInWindowCountScore extends WindowScore.AbstractWindowScore implements Comparable<EndInWindowCountScore>{

	private double count;  
	
	public EndInWindowCountScore(Annotation t) {
		super(t);
	}

	public EndInWindowCountScore(AlignmentModel model, Annotation annotation) {
		super(annotation);
		
		Predicate<Alignment> filter=new ReadEndsInFilter(annotation);
	...
	@Override
	public int compareTo(EndInWindowCountScore o) {
